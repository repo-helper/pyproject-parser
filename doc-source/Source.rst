...
The ``pyproject-parser`` source code is available on GitHub,
...
The recommended way to build ``pyproject-parser`` is to use `tox <https://tox.readthedocs.io/en/latest/>`_:
